...
const STRINGS = {
  ru: {
    ...
    chapter: 'Глава',
    level: 'Уровень',
    chapters: ['Граф связей', 'Магический квадрат', 'Геометрия фигур', 'Созвездия чисел'],
    chapterSub: ['Теория соединений', 'Числа в равновесии', 'Симметрия форм', 'Звёздные суммы'],
    settings: 'Настройки',
    sound: 'Звук',
    music: 'Музыка',
  ...
  en: {
    ...
    chapter: 'Chapter',
    level: 'Level',
    chapters: ['Graph of Bonds', 'Magic Square', 'Geometry of Forms', 'Constellations'],
    chapterSub: ['Theory of links', 'Numbers in balance', 'Symmetry of shapes', 'Astral sums'],
    settings: 'Settings',
    sound: 'Sound',
    music: 'Music',
    haptics: 'Haptics',
