...
const STRINGS = {
  ru: {
    ...
    chapter: 'Глава',
    level: 'Уровень',
    chapters: ['Граф связей', 'Магический квадрат', 'Тёмные звёзды', 'Созвездия чисел'],
    chapterSub: ['Теория соединений', 'Числа в равновесии', 'Свет во тьме', 'Звёздные суммы'],
    settings: 'Настройки',
    sound: 'Звук',
    music: 'Музыка',
  ...
  en: {
    ...
    chapter: 'Chapter',
    level: 'Level',
    chapters: ['Graph of Bonds', 'Magic Square', 'Dark Stars', 'Constellations'],
    chapterSub: ['Theory of links', 'Numbers in balance', 'Light in darkness', 'Astral sums'],
    settings: 'Settings',
    sound: 'Sound',
    music: 'Music',
    haptics: 'Haptics',
